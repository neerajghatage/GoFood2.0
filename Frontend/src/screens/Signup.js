...
//   // 11111111111
  ...
  //   const response = await fetch("https://symmetrical-palm-tree-4pxq756wp7j27jqj-5000.app.github.dev/api/getlocation", {
  //     method: 'POST',
  //     headers: {
...
// //   // 11111111111
    ...
    const handleSubmit= async(e)=>{
        e.preventDefault();
        const response=await fetch("https://symmetrical-palm-tree-4pxq756wp7j27jqj-5000.app.github.dev/api/createuser",{
            method:'POST',
            headers:{
                'Content-Type':'application/json'
            },
